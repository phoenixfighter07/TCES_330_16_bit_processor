...
vlog -work work +acc +cover "./DataMemory.v"
vlog -work work +acc +cover "./Datapath.sv"
vlog -work work +acc +cover "./ALU.sv"
vlog -work work +acc +cover "./Mux.sv"
vlog -work work +acc +cover "./regfile16x16.sv"
vlog -work work +acc +cover "./Controller.sv"
vlog -work work +acc +cover "./PC.sv"
vlog -work work +acc +cover "./IR.sv"
vlog -work work +acc +cover "./ROM_PC_IR.sv"
vlog -work work +acc +cover "./ControlFSM.sv"
vlog -work work +acc +cover "./InstMemory.v"
